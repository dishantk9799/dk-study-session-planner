    ...
    return (
        <div className='w-full flex flex-col gap-5 px-5 pt-5 text-zinc-200'>
            ...
            <div className='flex gap-2 flex-wrap'>
                ...
                <button onClick={() => setFilter("Web Dev")} className='flex border text-zinc-400 rounded-md border-zinc-600  hover:cursor-pointer hover:border-blue-600 hover:text-blue-600 duration-200 focus:bg-blue-600/20 focus:text-blue-600 focus:border-blue-600 px-3 py-1'>Web Dev</button>
